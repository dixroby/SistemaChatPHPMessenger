...
<html>
<head>
<title>Sistema de chat tusolutionweb</title>
  ...
  <div class="modal-dialog" style="float:right;width:20%">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background-color:#00a78e;">
        ...
        <h4 class="modal-title">Cambiar el perfil      	        	
        	</h4>
      </div>
      <div class="modal-body" >
        <center><p></p>
        	...
        	<p style="margin-bottom:10px;">
        			Seleccionar imagen<input name='file2' type='file' id='file2' >
           </p>  
           <p>
  ...
  <div class="modal-dialog" style="float:right;width:15%">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header"  style="background-color:#0091cd">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Cambiar ícono de grupo        	        	
        	</h4>
      </div>
      <div class="modal-body" >
        <center><p></p>
...
<body class="cbp-spmenu-push">
      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              <li class="header">
              	 <h4>SISTEMA PHP CHAT</h4>
              </li> 
              <li class="treeview">
                <a href="#">
                <i class="fa fa-bars"></i>
                <span>FUNCIONES DE CHAT</span>
                </a>
               <li class="treeview"> 
               	  <a href="#">             
                
                <span>1.  Crear un grupo</span> 
                </a>     
              </li> 
              <li class="treeview"> 
              	  <a href="#">             
                
                <span>2.Cambiar ícono de grupo</span>
                </a>      
              </li> 
              ...
              <li class="treeview"> 
                ...
                <span>3.Eliminar grupo</span>
                </a>      
              </li> 
              <li class="treeview">   
              	  <a href="#">           
           
                <span>4.Nombre del grupo que se puede hacer clic (Abrir)</span>
                </a>      
              </li>           
                <li class="treeview">
                	  <a href="#">              
               
                <span>5.Publicar en un grupo</span>
                </a>      
              </li>
              <li class="treeview">
                	  <a href="#">              
               
                <span>5.Ver imagen completa</span>
                </a>      
              </li>
              <li class="treeview">
                	  <a href="#">              
               
                <span>6.Haz clic en Imagen de usuarioe</span>
                </a>      
              </li>
              <li class="treeview">
                	  <a href="#">              
               
                <span>7.Cambiar foto de perfil</span>
                </a>      
              </li>
              <li class="treeview">
                	  <a href="#">              
               
                <span>6.Ver usuarios activos</span>
                </a>      
              </li>
              <li class="treeview">
                	  <a href="#">              
               
                <span>8.Solo permitido para tu grupo</span>
                </a>      
              </li>
              </li>           
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								 <li>
                                  <a data-toggle='modal' data-id='<?php echo$id; ?>' href='#Updatepicture' class='open-Updatepicture'><i class="fa fa-user"></i>Cambiar foto de perfil</a>
                                 </li>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box2">
					...
					<form id="comment_form" method="post" >
                            	<input type="text" id="txt" name="replied" style="width:80%;background-color: #F0F0F0;" placeholder="Eingrese su texto..">
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="#" target="">Sistema de chat tusolutionweb</a></p>		
	</div>
    <!--//footer-->
	</div>
